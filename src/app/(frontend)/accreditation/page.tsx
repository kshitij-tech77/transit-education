  ...
  return (
    <main className="pt-20">
      ...
      <section className="bg-black py-20 text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_#A93226_0%,_transparent_55%)] opacity-25" />
      ...
      <section className="py-16 bg-[#FEF2F1]">
        <div className="container">
          <div className="bg-white rounded-[2rem] border border-[#A93226]/20 shadow-sm overflow-hidden">
            <div className="p-8 md:p-12 flex flex-col md:flex-row items-center gap-10">
              <div className="w-28 h-28 md:w-40 md:h-40 rounded-3xl bg-[#A93226] flex items-center justify-center shrink-0 shadow-xl">
                <ShieldCheck className="w-16 h-16 md:w-24 md:h-24 text-white" />
              </div>
              <div className="flex-1 text-center md:text-left">
                <span className="inline-block bg-[#A93226]/10 text-[#A93226] text-xs font-black uppercase tracking-widest px-3 py-1.5 rounded-full mb-4">ICEF Verified Agency</span>
                ...
                <div className="mt-6 flex flex-wrap gap-4 justify-center md:justify-start">
                  <div className="flex items-center gap-2 bg-[#A93226]/5 rounded-xl px-4 py-2">
                    <CheckCircle2 className="w-4 h-4 text-[#A93226]" />
