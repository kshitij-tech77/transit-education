...
const BENEFITS = [
  ...
  },
  {
    ...
    desc: "Access our network of 300+ partner universities across USA, UK, Canada, Australia, and more.",
  },
  {
    icon: Users,
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="bg-[#F7F3F3] rounded-3xl p-8 md:p-12 border border-gray-100 space-y-5">
              ...
              <div className="grid md:grid-cols-2 gap-5">
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">City / Location *</label>
                  <input
                    type="text"
                    required
                    value={form.city}
              ...
              <div>
                <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Business Background</label>
                <textarea
                  rows={3}
