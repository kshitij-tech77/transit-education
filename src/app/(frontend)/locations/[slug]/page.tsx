...
const locationsData = {
  "kathmandu": {
    ...
    heroImage: "/media-images/2026/04/Transit-ktm-1.png",
    gallery: [
      "/media-images/2026/04/Transit-ktm-2.png",
      "/media-images/2026/04/Transit-3-ktm.png"
    ],
    whyChooseUs: [
  ...
  "itahari": {
    ...
    heroImage: "/media-images/2026/04/Transit-ithari.png",
    gallery: [
      "/media-images/2026/04/Transit-consultancy-ithari-front-desk.png",
      "/media-images/2026/04/Transit-education-ithari-team.png",
      "/media-images/2026/04/Transit-consultancy-ithari-front-desk-2.png"
    ],
    whyChooseUs: [
  ...
  "damak": {
    ...
    heroImage: "/media-images/2026/04/Transit-Consultancy-Damak-.png",
    gallery: [
      "/media-images/2026/04/Transite-consultancy-damak-frontedsk.png",
      "/media-images/2026/04/Transit-consultancy-damak-team.png",
      "/media-images/2026/04/Transit-consultancy-Damak-gate.png"
    ],
    whyChooseUs: [
  ...
  "damauli": {
    ...
    heroImage: "/media-images/2026/04/Transit-Education-Damauli-.png",
    gallery: [
      "/media-images/2026/04/Transit-education-damauli-office.png",
      "/media-images/2026/04/Transit-education-damauli-class.png",
      "/media-images/2026/04/Transit-education-damauli-wwaiting.png",
      "/media-images/2026/04/Transit-education-damauli.png"
    ],
    whyChooseUs: [
