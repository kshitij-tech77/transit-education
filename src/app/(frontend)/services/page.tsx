  ...
  return (
    <main className="pt-20">
      ...
      <section className="bg-black pt-32 pb-24 md:py-32 text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-20 bg-[url('https://vlrhwdcqzpfqpbqeaqyr.supabase.co/storage/v1/object/public/media/2021/04/lets-plan.webp')] bg-cover bg-center" />
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div 
                key={index} 
                className="group bg-off-white p-12 rounded-[3rem] border border-gray-100 hover:border-brand/20 transition-all hover:shadow-xl hover:shadow-brand/5"
              >
