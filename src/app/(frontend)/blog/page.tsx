              ...
              {blogPosts.length > 0 ? blogPosts.map((post) => (
                <article key={post.id} className="group">
                  <Link href={`/blog/${post.slug}`} className="block relative h-[400px] rounded-[2.5rem] overflow-hidden mb-8 shadow-lg group-hover:shadow-2xl transition-all duration-500">
                    ...
                    <Image
                      src={post.featuredImage ? resolveMediaUrl(post.featuredImage) : "https://vlrhwdcqzpfqpbqeaqyr.supabase.co/storage/v1/object/public/media/2021/03/micheile-henderson-ZVprbBmT8QA-unsplash-scaled.webp"}
                      alt={post.title}
                      fill
