...
export default function CareersPage() {
  ...
  // Fetch openings once on first render
  if (openings === null) {
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 space-y-5">
              ...
              <div className="grid md:grid-cols-2 gap-5">
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Position Applying For *</label>
                  <input
                    type="text"
                    required
                    value={form.position}
              ...
              <div>
                <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Upload CV / Resume (PDF, max 5MB)</label>
                <input
                  ref={fileRef}
                  type="file"
                  accept=".pdf"
