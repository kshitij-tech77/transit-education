...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE_URL}/study-abroad/ireland` },
  openGraph: {
    ...
    url: `${SITE_URL}/study-abroad/ireland`,
    type: "website",
  },
};
  ...
  return (
    <main>
      ...
      <DestinationHero 
        ...
        image="https://res.cloudinary.com/xgpct4gs/image/upload/media/2021/05/Europe-web-banner.png"
      />
