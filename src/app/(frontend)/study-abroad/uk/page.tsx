...
export default async function UKPage() {
  ...
  // Fallback to Global FAQs if none for UK
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              ...
              <h2 className="text-3xl font-bold text-black mt-4 mb-8">Academic Heritage & Global Success</h2>
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-black mb-2">Short Duration</h3>
                    <p className="text-gray-600 text-sm">Most Masters programs in the UK are 1 year, and Bachelors are 3 years, saving you time and living costs.</p>
                  </div>
                </div>
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex gap-4">
                  <CheckCircle2 className="w-8 h-8 text-brand shrink-0" />
                  <div>
                    <h3 className="font-bold text-black mb-2">Global Standing</h3>
                    <p className="text-gray-600 text-sm">UK universities are among the highest-ranked globally, offering a degree that is recognized everywhere.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-10 rounded-[2rem] border border-gray-100 shadow-xl">
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                {country.intakes || "The main intakes in the UK are January/February and September/October. Some universities also have a May intake."}
              </p>
              <h3 className="text-xl font-bold text-black mb-4">Required Documents:</h3>
              <ul className="grid grid-cols-1 gap-3">
                {["Updated Resume", "Statement of Purpose (SOP)", "Academic Transcripts", "Passport Copy", "IELTS / PTE / Duolingo Score", "Two LORs"].map((doc) => (
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="p-8 rounded-3xl bg-brand/5 border border-brand/10">
                ...
                <ul className="space-y-4">
                  {(country.entry_requirements.ug || ["60% in Grade 12 (NEB).", "IELTS 6.0 (5.5) or equivalent."]).map((req: string, i: number) => (
              ...
              <div className="p-8 rounded-3xl bg-black/5 border border-black/10">
                ...
                <ul className="space-y-4">
                  {(country.entry_requirements.pg || ["Minimum 55-60% in Bachelors Degree.", "IELTS 6.5 (6.0) or equivalent."]).map((req: string, i: number) => (
                    <li key={i} className="flex gap-3 text-gray-700">
        ...
        <section className="py-24 bg-off-white">
          <div className="container max-w-4xl">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl font-bold text-black mt-4">Student Visa (Tier 4) Process</h2>
            </div>
