...
export default async function USAPage() {
  ...
  // Fallback to Global FAQs if none for USA
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              ...
              <h2 className="text-3xl font-bold text-black mt-4 mb-8">The Land of Opportunity & Innovation</h2>
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">The US is home to many world-class universities with a strong focus on research and innovation.</p>
                  </div>
                </div>
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex gap-4">
                  <CheckCircle2 className="w-8 h-8 text-brand shrink-0" />
                  <div>
                    <h3 className="font-bold text-black mb-2">Flexible Learning</h3>
                    <p className="text-gray-600 text-sm">The American education system offers unmatched flexibility in choice of subjects and specializations.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-10 rounded-[2rem] border border-gray-100 shadow-xl">
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                {country.intakes || "The major intakes in the USA are Fall (August/September) and Spring (January). Some universities also have a Summer intake (May)."}
              </p>
              <h3 className="text-xl font-bold text-black mb-4">Required Documents:</h3>
              <ul className="grid grid-cols-1 gap-3">
                {["Academic Transcripts", "Standardized Tests (SAT/GRE/GMAT)", "English Proficiency (TOEFL/IELTS)", "Statement of Purpose", "Letters of Recommendation", "Passport Copy", "Financial Documents"].map((doc) => (
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="p-8 rounded-3xl bg-brand/5 border border-brand/10">
                ...
                <ul className="space-y-4">
                  {(country.entry_requirements.ug || ["3.0+ GPA in Grade 12.", "SAT often required for scholarships.", "IELTS 6.5 or TOEFL 80."]).map((req: string, i: number) => (
              ...
              <div className="p-8 rounded-3xl bg-black/5 border border-black/10">
                ...
                <ul className="space-y-4">
                  {(country.entry_requirements.pg || ["Minimum 2.75 - 3.0 GPA in Bachelors.", "GRE/GMAT for top programs.", "IELTS 6.5 - 7.0 or equivalent."]).map((req: string, i: number) => (
                    <li key={i} className="flex gap-3 text-gray-700">
        ...
        <section className="py-24 bg-off-white">
          <div className="container max-w-4xl">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl font-bold text-black mt-4">F1 Student Visa Journey</h2>
            </div>
