...
export function ReferralCodeCard({ referralCode }: ReferralCodeCardProps) {
  ...
  return (
    <div className="bg-brand rounded-2xl shadow-sm p-7 text-white space-y-4">
      <div className="flex items-center gap-2">
        <Share2 size={18} />
        <p className="text-lg font-semibold">Your Referral Code</p>
      </div>
      <p className="text-sm opacity-90">Share this code with friends — you&apos;ll both earn points when they join.</p>
