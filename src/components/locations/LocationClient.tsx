    ...
    <div className="font-sans antialiased text-[#111] bg-white overflow-x-hidden">
      ...
      <section className="relative min-h-[92vh] bg-black overflow-hidden flex items-center">
        ...
        <div className="container relative z-[2] max-w-[1180px] mx-auto px-14 w-full">
          <div className="inline-flex items-center gap-2 bg-[#A932261A] border border-[#A9322661] text-[#e8a09a] text-[10px] font-semibold tracking-[0.16em] uppercase px-4 py-2 rounded-full mb-7 animate-fade-in">
          ...
          <h1 className="text-[clamp(40px,5.5vw,74px)] font-extrabold leading-[1.03] text-white tracking-[-0.025em] mb-6 max-w-[680px] animate-slide-up">
            {slug === 'kathmandu' ? (
              <>Nepal's Central<br />Gateway to<br /><span className="text-[#A93226]">Global Education</span></>
            ) : slug === 'itahari' ? (
              <>Eastern Nepal's<br />Gateway to<br /><span className="text-[#A93226]">Global Education</span></>
            ) : (
              <>{location.name.split(' ')[0]}'s Gateway to<br /><span className="text-[#A93226]">Global Education</span></>
            )}
          </h1>
          ...
          <div className="flex gap-4 flex-wrap animate-slide-up [animation-delay:380ms]">
            <button 
              ...
              className="bg-[#A93226] text-white text-[13px] font-semibold tracking-[0.04em] px-8 py-4 rounded-[10px] hover:bg-[#7E2219] hover:-translate-y-[2px] transition-all duration-200"
            >
        ...
        <div className="absolute bottom-14 right-14 flex gap-12 z-[2] animate-fade-in [animation-delay:500ms]">
          <div className="text-right">
            <div className="text-[38px] font-extrabold text-white leading-none tracking-[-0.03em]">2000<span className="text-[#A93226]">+</span></div>
            <div className="text-[9px] font-medium text-[#4a4a4a] tracking-[0.1em] uppercase mt-1">Students Sent Abroad</div>
          </div>
          <div className="text-right">
            <div className="text-[38px] font-extrabold text-white leading-none tracking-[-0.03em]">98<span className="text-[#A93226]">%</span></div>
            <div className="text-[9px] font-medium text-[#4a4a4a] tracking-[0.1em] uppercase mt-1">Visa Success Rate</div>
          </div>
          <div className="text-right">
            <div className="text-[38px] font-extrabold text-white leading-none tracking-[-0.03em]">15<span className="text-[#A93226]">+</span></div>
        ...
        <div className="absolute bottom-9 left-14 flex gap-2 z-[2]">
          {slides.map((_, index) => (
            <div
              ...
              className={`h-[3px] rounded-[2px] cursor-pointer transition-all duration-300 ${index === currentSlide ? 'w-[44px] bg-[#A93226]' : 'w-[24px] bg-white/20'}`}
            />
          ))}
        </div>
      </section>
      ...
      {/* ─── INFO BAR ─── */}
      <div className="bg-[#A93226] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        <a href={`tel:${location.phone}`} className="flex items-center gap-[14px] px-7 py-[22px] border-r border-white/15 hover:bg-[#7E2219] transition-colors group">
        ...
        <a href={`https://maps.google.com/?q=${encodeURIComponent(location.address)}`} target="_blank" className="flex items-center gap-[14px] px-7 py-[22px] border-r border-white/15 hover:bg-[#7E2219] transition-colors group">
          <div className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center transition-colors group-hover:bg-white/20">
        ...
        <div className="flex items-center gap-[14px] px-7 py-[22px] border-r border-white/15 hover:bg-[#7E2219] transition-colors group cursor-default">
          <div className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center transition-colors group-hover:bg-white/20">
        ...
        <a href={`https://wa.me/977${location.whatsapp}`} target="_blank" className="flex items-center gap-[14px] px-7 py-[22px] hover:bg-[#7E2219] transition-colors group">
          <div className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center transition-colors group-hover:bg-white/20">
      ...
      {isPopupOpen && (
        <div className="fixed inset-0 z-[99999] bg-black/75 flex items-center justify-center p-5">
          <div className="bg-white max-w-[460px] w-full rounded-2xl overflow-hidden relative max-h-[92vh] overflow-y-auto animate-scale-in">
            ...
            <div className="bg-[#A93226] p-8 pt-8 pb-6 text-white">
            ...
            <div className="p-8 pt-7 pb-8 space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-[#FAFAF8] border border-[#E5E4E0] px-[15px] py-[13px] rounded-[10px] text-[13px] outline-none focus:border-[#A93226] transition-colors"
                  value={formData.name}
              ...
              <div>
                ...
                <select 
                  className="w-full bg-[#FAFAF8] border border-[#E5E4E0] px-[15px] py-[13px] rounded-[10px] text-[13px] outline-none focus:border-[#A93226] transition-colors appearance-none"
